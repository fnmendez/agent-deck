...
var probeASTExpectedCalls = map[string][]string{
	...
	"cmd.runStrictAdmissionProbe":       probeCalls("verifier.verify"),
	"cmd.verifier.verify":               probeCalls("v.deps.codex", "v.deps.idle", "v.deps.native"),
	...
	"cmd.strictClaudeLinuxProcessProof": probeCalls("bootTime.Add", "deps.open", "deps.readBounded", "deps.readlink", "deps.stat", "fail", "held.Close", "held.Stat",
		"info.Mode().Perm", "os.FileMode", "processStart.UTC", "recordStart.Sub", "strconv.FormatUint", "strconv.ParseInt", "strictFileIdentity", "strictLinuxBootID.MatchString",
		"strictLinuxBootTime", "strictLinuxPIDNamespace.MatchString", "strictMatchLinuxProcessStatus", "strictParseLinuxProcessStat",
		"time.Duration", "time.UnixMilli", "time.UnixMilli(record.StartedAt).UTC", "ttyInfo.Sys", "uint64"),
	...
	"tmux.strictProbeIdentity":                 probeCalls("snapshot"),
