...
var probeASTExpectedCalls = map[string][]string{
	...
	"cmd.strictNativeThread":                   probeCalls("strictClaudeThreadProof", "target.StrictThreadEnvironment"),
	"cmd.strictClaudeThreadProof":              probeCalls("os.UserHomeDir", "session.GetClaudeConfigDirForInstance", "strictClaudeThreadProofWithRun"),
	...
	"cmd.strictClaudeOwnedBinding":             probeCalls("fail", "file.Close", "file.Stat", "io.LimitReader", "io.ReadAll", "os.Getuid", "strictFileIdentity", "strictOpenVerifiedPath"),
	...
	"cmd.strictCodexRuntimeProof":              probeCalls("strictCodexProofWithRun", "strictPlatformSupported"),
