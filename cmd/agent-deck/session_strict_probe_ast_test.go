...
var probeASTClosure = []probeASTFunction{
	...
	{"cmd.strictClaudeLinuxPackageDirectoryMode", "session_strict_linux_native.go", "strictClaudeLinuxPackageDirectoryMode", ""},
	...
	{"tmux.StrictComposerError.Error", "../../internal/tmux/strict_send.go", "Error", "StrictComposerError"},
	...
	{"tmux.strictOperatorState", "../../internal/tmux/strict_send.go", "strictOperatorState", ""},
	{"tmux.strictOperatorQuietWindow", "../../internal/tmux/strict_send.go", "strictOperatorQuietWindow", ""},
	{"tmux.ValidStrictOperatorQuiet", "../../internal/tmux/strict_send.go", "ValidStrictOperatorQuiet", ""},
...
var probeASTExpectedCalls = map[string][]string{
	...
	"cmd.runStrictAdmissionProbe":       probeCalls("errors.As", "observe", "safeStrictProbeReason", "verifier.verify"),
	...
	"cmd.strictClaudeLinuxDefaultDeps":  probeCalls("os.Getgid", "os.Getuid"),
	...
	"cmd.strictClaudeLinuxPackageProofWithLinks": probeCalls("directory.Stat", "directoryAfter.ModTime", "directoryAfter.Mode", "directoryAfter.Sys", "directoryBefore.IsDir", "directoryBefore.ModTime", "directoryBefore.ModTime().Equal", "directoryBefore.ModTime().UnixNano", "directoryBefore.Mode", "directoryBefore.Mode().Perm", "directoryBefore.Sys", "fail", "handles.Close", "strictClaudeLinuxOwnedPackageFile", "strictClaudeLinuxPackageDirectoryMode", "strictClaudeLinuxPackagePath", "strictFileIdentity", "strictOpenVerifiedDirectory", "uint64"),
	"cmd.strictClaudeLinuxPackageDirectoryMode":  probeCalls("uint64"),
	...
	"cmd.strictClaudeLinuxProcessProof": probeCalls("after.ModTime().Equal", "after.Sys", "bootTime.Add", "deps.open", "deps.readBounded", "deps.readlink", "deps.stat", "fail", "handles.Close", "held.Stat",
		"info.Mode().Perm", "machineBinding.signature", "os.FileMode", "processStart.UTC", "recordStart.Sub", "strconv.FormatUint", "strconv.ParseInt",
	...
	"tmux.StrictComposerError.Error":           probeCalls(),
	"tmux.strictSnapshot":                      probeCalls("captureStrictSnapshot", "s.paneLineDiscipline", "strictOperatorQuietWindow"),
	"tmux.captureStrictSnapshot":               probeCalls("rawMode", "read", "strictOperatorQuietWindow", "strictOperatorState"),
	"tmux.strictOperatorState":                 probeCalls("strconv.ParseInt"),
	"tmux.strictOperatorQuietWindow":           probeCalls("ValidStrictOperatorQuiet"),
	"tmux.ValidStrictOperatorQuiet":            probeCalls(),
